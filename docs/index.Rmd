...
- Combines methods across multiple fields to .nicegreen[extract actionable information]
]]
...
data.frame(
  ...
  DT::formatStyle(c("Number"),
                  ...
                  color = DT::styleEqual(c("1", 
                                           ...
                                           "4",
                                           "5"), 
                                         c("black", "white", "white", "white", "white")))
```

???
  - There are five common approaches, but we don't have time to talk about each in detail
...
data.frame(
  ...
  DT::formatStyle(c("Number"),
                  ...
                  color = DT::styleEqual(c("1", 
                                           ...
                                           "4",
                                           "5"), 
                                         c("black", "black", "black", "black", "white")))
```
...
3. Works for any type of GLM (and GLMM)
]

--

.large[.nicegreen[Let's us interpret GLM's just like linear regression]]
...
$$
AME_k = \frac{f(\beta_k [x_k + h] + \beta X) - f(\beta_k x_k + \beta X)}{h}
$$
...
.large[Note: All] $e_i$.large['s are normally distributed with] $\mu = 0$ .large[and] $SD = 1$
...
.huge[.dcoral[
Let's discuss one of my recent projects in this area:]
